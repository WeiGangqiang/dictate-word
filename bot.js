...
const luckyNumberBot = new Chatbot('horoscope', 'lucky-number', 'http://101.132.183.112:6060/query');
const luckyColorBot = new Chatbot('horoscope', 'lucky-color', 'http://101.132.183.112:6060/query');
